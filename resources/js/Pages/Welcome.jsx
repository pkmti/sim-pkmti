                ...
                <main className='px-6 sm:px-0'>
                    ...
                    <section className='flex flex-col-reverse lg:flex-row items-center w-full gap-6 sm:px-12 mt-20'>
                        ...
                        className='flex flex-col w-full lg:w-1/2'>
                            ...
                            <h3 className='capitalize text-3xl md:text-4xl lg:text-5xl font-bold text-secondary leading-12 md:leading-16'>Bertemu dengan mereka yang sudah profesional</h3>
